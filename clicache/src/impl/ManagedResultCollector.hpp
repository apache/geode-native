  ...
  namespace geode {
    namespace client {
      ...
      public:
       ...
       std::shared_ptr<native::CacheableVector> getResult(System::UInt32 timeout = DEFAULT_QUERY_RESPONSE_TIMEOUT);
        void addResult(const std::shared_ptr<native::Cacheable>& result);
        void endResults();
        void clearResults();
        /// <summary>
