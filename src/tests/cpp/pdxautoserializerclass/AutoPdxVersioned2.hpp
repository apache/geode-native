...
#ifndef GEODE_PDXAUTOSERIALIZERCLASS_AUTOPDXVERSIONED2_H_
#define GEODE_PDXAUTOSERIALIZERCLASS_AUTOPDXVERSIONED2_H_
...
#endif  // GEODE_PDXAUTOSERIALIZERCLASS_AUTOPDXVERSIONED2_H_
