...
set(_GEODE_HOME "")
if(GEODE_HOME AND IS_DIRECTORY "${GEODE_HOME}")
  set(_GEODE_HOME "${GEODE_HOME}")
  set(_GEODE_HOME_EXPLICIT 1)
else()
  set(_ENV_GEODE_HOME "")
  if(DEFINED ENV{GEODE_HOME})
    file(TO_CMAKE_PATH "$ENV{GEODE_HOME}" _ENV_GEODE_HOME)
  elseif(DEFINED ENV{GEODE_HOME})
    file(TO_CMAKE_PATH "$ENV{GEODE_HOME}" _ENV_GEODE_HOME)
  elseif(DEFINED ENV{GEODE})
    file(TO_CMAKE_PATH "$ENV{GEODE}" _ENV_GEODE_HOME)
  endif()
  if(_ENV_GEODE_HOME AND IS_DIRECTORY "${_ENV_GEODE_HOME}")
    set(_GEODE_HOME "${_ENV_GEODE_HOME}")
    set(_GEODE_HOME_EXPLICIT 0)
  endif()
  unset(_ENV_GEODE_HOME)
endif()

set(_GEODE_HINTS)
if(_GEODE_HOME)
  set(_GEODE_HINTS ${_GEODE_HOME}/bin)
endif()
