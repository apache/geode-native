...
class PdxWriterWithTypeCollector : public PdxLocalWriter {
 ...
 public:
  ...
  std::shared_ptr<PdxType> getPdxLocalType();
  ...
  int32_t calculateLenWithOffsets() override;

  void writeOffsets(int32_t len) override;

  PdxWriter& writeChar(const std::string& fieldName, char16_t value) override;

  PdxWriter& writeBoolean(const std::string& fieldName, bool value) override;

  PdxWriter& writeByte(const std::string& fieldName, int8_t value) override;

  PdxWriter& writeShort(const std::string& fieldName, int16_t value) override;

  PdxWriter& writeInt(const std::string& fieldName, int32_t value) override;

  PdxWriter& writeLong(const std::string& fieldName, int64_t value) override;

  PdxWriter& writeFloat(const std::string& fieldName, float value) override;

  PdxWriter& writeDouble(const std::string& fieldName, double value) override;
  ...
  PdxWriter& writeCharArray(const std::string& fieldName,
  ...
  PdxWriter& writeShortArray(const std::string& fieldName,
  ...
  PdxWriter& writeDoubleArray(const std::string& fieldName,
                              const std::vector<double>& array) override;

  PdxWriter& writeStringArray(const std::string& fieldName,
  ...
  PdxWriter& markIdentityField(const std::string& fieldName) override;
