...
template APACHE_GEODE_EXPORT void DataOutput::writeJavaModifiedUtf8(
    const std::string&);
...
template APACHE_GEODE_EXPORT void DataOutput::writeUtf16Huge(const std::string&);
...
template APACHE_GEODE_EXPORT void DataOutput::writeUtf16Huge(const std::u32string&);
...
template APACHE_GEODE_EXPORT void DataOutput::writeUtf16(const std::string&);
...
template APACHE_GEODE_EXPORT void DataOutput::writeUtf16(const std::u32string&);
