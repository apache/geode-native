...
uint16_t MemberListForVersionStamp::add(std::shared_ptr<DSMemberForVersionStamp> member) {
...
std::shared_ptr<DSMemberForVersionStamp> MemberListForVersionStamp::getDSMember(
  ...
  std::unordered_map<uint32_t, std::shared_ptr<DSMemberForVersionStamp>>::iterator it =
