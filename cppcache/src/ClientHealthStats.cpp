...
size_t ClientHealthStats::objectSize() const {
  return sizeof(ClientHealthStats);
}

std::shared_ptr<ClientHealthStats> ClientHealthStats::create(
    int gets, int puts, int misses, int listCalls, int numThreads,
    int64_t cpuTime, int cpus) {
