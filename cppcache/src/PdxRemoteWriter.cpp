...
std::shared_ptr<PdxWriter> PdxRemoteWriter::writeBoolean(const char* fieldName,
                                                         bool value) {
  writePreserveData();
  PdxLocalWriter::writeBoolean(fieldName, value);
  return shared_from_this();
 }
 std::shared_ptr<PdxWriter> PdxRemoteWriter::writeByte(const char* fieldName,
                                                       int8_t value) {
   writePreserveData();
   PdxLocalWriter::writeByte(fieldName, value);
   return shared_from_this();
 }
 std::shared_ptr<PdxWriter> PdxRemoteWriter::writeShort(const char* fieldName,
                                                        int16_t value) {
   writePreserveData();
   PdxLocalWriter::writeShort(fieldName, value);
   return shared_from_this();
 }
 std::shared_ptr<PdxWriter> PdxRemoteWriter::writeInt(const char* fieldName,
                                                      int32_t value) {
   writePreserveData();
 ...
 std::shared_ptr<PdxWriter> PdxRemoteWriter::writeFloat(const char* fieldName,
                                                        float value) {
   writePreserveData();
