...
void AttributesMutator::setCacheListener(const std::shared_ptr<CacheListener>& aListener) {
  RegionInternal* rImpl = dynamic_cast<RegionInternal*>(m_region.get());
...
void AttributesMutator::setCacheLoader(const std::shared_ptr<CacheLoader>& aLoader) {
  RegionInternal* rImpl = dynamic_cast<RegionInternal*>(m_region.get());
...
void AttributesMutator::setCacheWriter(const std::shared_ptr<CacheWriter>& aWriter) {
  RegionInternal* rImpl = dynamic_cast<RegionInternal*>(m_region.get());
