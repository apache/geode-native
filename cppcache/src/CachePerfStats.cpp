...
CachePerfStats::CachePerfStats(StatisticsFactory* factory) {
  ...
  void CachePerfStats::close() {
    m_cachePerfStats->close();
  }

  void CachePerfStats::incDestroys() { m_cachePerfStats->incInt(m_destroysId, 1); }
  ...
  void CachePerfStats::incOverflows() { m_cachePerfStats->incInt(m_overflowsId, 1); }

  void CachePerfStats::incRetrieves() { m_cachePerfStats->incInt(m_retrievesId, 1); }
