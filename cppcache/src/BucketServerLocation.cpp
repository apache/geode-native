...
BucketServerLocation::BucketServerLocation(int bucketId, int port,
                                           std::string host, bool isPrimary,
                                           int8_t version)
...
BucketServerLocation::BucketServerLocation(
    int bucketId, int port, std::string host, bool isPrimary, int8_t version,
    std::vector<std::string> serverGroups)
    : ServerLocation(host, port),
      m_bucketId(bucketId),
      m_isPrimary(isPrimary),
      m_version(version) {
...
BucketServerLocation& BucketServerLocation::operator=(
    const BucketServerLocation& rhs) {
