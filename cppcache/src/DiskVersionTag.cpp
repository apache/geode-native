...
DiskVersionTag::DiskVersionTag(MemberListForVersionStamp& memberListForVersionStamp)
...
DiskVersionTag::DiskVersionTag(int32_t entryVersion, int16_t regionVersionHighBytes,
