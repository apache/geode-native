...
namespace client {
class CqQuery;
typedef std::unordered_map<std::shared_ptr<CacheableKey>, int, CacheableKey::hash,
...
typedef ACE_Hash_Map_Manager_Ex<std::string, std::shared_ptr<Region>, ACE_Hash<std::string>,
                                ACE_Equal_To<std::string>,
                                ACE_Recursive_Thread_Mutex>
    MapOfRegionWithLock;
typedef ACE_Hash_Map_Manager_Ex<std::string, std::shared_ptr<CqQuery>, ACE_Hash<std::string>,
                                ACE_Equal_To<std::string>,
                                ACE_Recursive_Thread_Mutex>
