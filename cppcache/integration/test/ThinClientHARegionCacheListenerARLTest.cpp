...
class ThinClientHARegionCacheListenerARLTest : public ::testing::Test {
 protected:
  ...
  ThinClientHARegionCacheListenerARLTest()
      : verified_{false},
        verify_the_regionevent_callback{
            ::testing::Invoke(this, &ThinClientHARegionCacheListenerARLTest::
                                        verify_regionevent_callback)},
        verify_the_entryevent_callback{
            ::testing::Invoke(this, &ThinClientHARegionCacheListenerARLTest::
                                        verify_entryevent_callback)},
        the_verification_condition{std::bind(
            &ThinClientHARegionCacheListenerARLTest::is_verified, this)} {
  ...
  ~ThinClientHARegionCacheListenerARLTest() override {
 ...
 public:
  static void SetUpTestSuite() {
    ...
    cluster_ =
        make_unique<::Cluster>(Name{"ThinClientHARegionCacheListenerARLTest"},
...
::std::unique_ptr<::Cluster> ThinClientHARegionCacheListenerARLTest::cluster_{};

::std::shared_ptr<::apache::geode::client::Nice_MockListener>
    ThinClientHARegionCacheListenerARLTest::listener_{};

::std::unique_ptr<::apache::geode::client::Cache>
    ThinClientHARegionCacheListenerARLTest::cache_{};
::std::shared_ptr<::apache::geode::client::Region>
    ThinClientHARegionCacheListenerARLTest::region_{};
}  // namespace
