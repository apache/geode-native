...
class CacheableWrapper {
 ...
 public:
  ...
  virtual std::shared_ptr<Cacheable> getCacheable() const { return m_cacheableObject; }
  ...
  virtual uint32_t getCheckSum(const std::shared_ptr<Cacheable> object) const = 0;
